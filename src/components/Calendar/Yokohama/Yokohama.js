    ...
    <div className='table_container'>
        <div>
            ...
            <Grid container className='table_row'>
              <Grid item lg={3}>
              AFA Yokohama Senior Kids (12 to 16 Years)
              </Grid>
              <Grid item lg={3}>
              Date
              </Grid>
            ...
            <Grid container className='table_row'>
              <Grid item lg={3}>
              AFA Yokohama Junior Kids J1 (8 to 12 Years)
              </Grid>
              <Grid item lg={3}>
              Date
              </Grid>
            ...
            <Grid container className='table_row'>
              <Grid item lg={3}>
              AFA Yokohama Junior Kids J2 (8 to 12 Years)
              </Grid>
              <Grid item lg={3}>
              Date
              </Grid>
            ...
            <Grid container className='table_row'>
              <Grid item lg={3}>
              AFA Yokohama Sub Junior Kids (4 to 8 Years)
              </Grid>
              <Grid item lg={3}>
              Date
              </Grid>
